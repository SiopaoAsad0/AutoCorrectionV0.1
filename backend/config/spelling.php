...
return [
    ...
    'length_tolerance' => 2,
    'candidate_top_n' => (int) env('SPELLING_CANDIDATE_TOP_N', 5),
    'min_candidate_confidence' => (float) env('SPELLING_MIN_CANDIDATE_CONFIDENCE', 0.38),
    'min_context_probability' => (float) env('SPELLING_MIN_CONTEXT_PROBABILITY', 0.1),
    'min_frequency_cutoff' => (int) env('SPELLING_MIN_FREQUENCY', 1),
    ...
    */
    ...
    'prediction_bigrams' => [
        ...
        "i don't" => ['know', 'think', 'want', 'like', 'have'],
        "i didn't" => ['know', 'mean', 'expect', 'see', 'finish'],
        "we didn't" => ['know', 'finish', 'expect', 'receive'],
        "it didn't" => ['work', 'load', 'start', 'save'],
        'did not' => ['work', 'know', 'finish', 'arrive'],
        "can't" => ['go', 'find', 'open', 'access'],
        "we can't" => ['go', 'continue', 'submit', 'start'],
        'i am' => ['going', 'trying', 'working', 'ready'],
        "i'm" => ['going', 'trying', 'working', 'ready'],
        'thank you' => ['po', 'for', 'so', 'very'],
        'good' => ['morning', 'afternoon', 'evening', 'job'],
        'see you' => ['later', 'tomorrow', 'soon'],
    ],
    'prediction_trigrams' => [
        "i didn't" => ['know', 'mean', 'expect', 'see'],
        "we didn't" => ['know', 'finish', 'submit', 'expect'],
        "it didn't" => ['work', 'load', 'start', 'save'],
        "i don't" => ['know', 'have', 'think', 'want'],
        'did not' => ['work', 'know', 'finish', 'arrive'],
        "can't" => ['go', 'find', 'open', 'access'],
        "i am" => ['going', 'trying', 'working', 'ready'],
        'thank you' => ['for', 'so', 'very', 'po'],
        'going to' => ['the', 'a', 'school', 'work'],
        'will be' => ['there', 'ready', 'fine', 'done'],
    ],
